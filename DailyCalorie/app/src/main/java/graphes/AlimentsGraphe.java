...
public class AlimentsGraphe extends Activity{
    ...
    String caloriePicker(String name){
        ...
        public Intent getIntent (Context context){
            ...
            int x =0;
            int size=0;
            HashMap<String,Double> somme = new HashMap<String,Double>();
           ...
           double idealDouble= Double.parseDouble(calorieIdeal);
            ...
            mRenderer.setChartTitle("Aliments");
            mRenderer.setYTitle("Calories obtenu");
